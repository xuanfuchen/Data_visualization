...
def home(request):
    ...
    top_sector_name_list = []
    top_sector_sales_list = []
    ...
    for x in top_dict:
        ...
        top_sector_name_list.append(x[0])
        top_sector_sales_list.append(x[1])
    ...
    dbData = { 
        ...
        "top_sector_name_list": top_sector_name_list,
        "top_sector_sales_list": top_sector_sales_list,
